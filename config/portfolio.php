...
return [
    'meta' => [
        ...
        'keywords' => ['Laravel', 'React', 'PHP', 'Full Stack Developer', 'Davao', 'Internship'],
    ],

    'hero' => [
        'name' => 'Jomarie T. Travilla',
        'roles' => ['Full Stack Developer', 'Laravel Developer', 'React Developer', 'Vibe Coder'],
    ...
    'contact' => [
        ...
        'recipient' => 'jomtravilla.dev@gmail.com',
        'location' => '09482414092 � Davao City, Philippines',
        'responseTime' => 'Usually replies within 1 hour',
    ],

    'chat' => [
        'welcome' => 'Hi, I am Jomarie\'s portfolio assistant. Ask about my stack, projects, experience, or how to get in touch.',
        'suggestions' => [
            'What is your preferred tech stack?',
            'Tell me about CoolMasterSpecialist.',
            'How can I shoot you an email?',
        ],
    ],
];
